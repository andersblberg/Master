...
parser.add_argument("--csv", default="data/interim/combined_DB22_measurements_sorted_clean.csv")
parser.add_argument("--model", required=True, help="registry key, e.g. rf, et, svm_pca8")
...
def et_space(trial):
    return {
        ...
        "max_depth"  : trial.suggest_categorical(
            "max_depth",
            [None] + list(range(5, 55, 5))          # None, 5, 10, … 50
        ),
        # standard choices
